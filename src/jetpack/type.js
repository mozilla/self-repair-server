...
let isMap = function (value) {return Object.prototype.toString.call(value) === "[object Map]"}
exports.isMap = isMap;

let isSet = function (value) {return Object.prototype.toString.call(value) === "[object Set]"}
exports.isSet = isSet;
